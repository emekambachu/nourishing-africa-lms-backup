$(document).ready(function(){
    ...
    document.getElementById("sign-up-button").addEventListener("click", function(event){
        ...
        if (focusArea === "") {
            document.getElementsByName("focus_area")[0].classList.add('na-form-input-error');
            ...
            document.getElementsByName("focus_area")[0].classList.remove('na-form-input-error');
        ...
        let links = [website, facebook, linkedin];
