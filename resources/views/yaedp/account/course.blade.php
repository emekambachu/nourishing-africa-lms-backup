                            ...
                            <div class="row">
                                <div class="col-12 pl-3 pr-3 mb-3">
                                    <label for="" class="float-left align-items-center discussion-comment-text">
                                        ({{ \App\Models\Learning\Discussion\LearningDiscussion::getDiscussionCount($course) }}
                                        )
                                        Comment{{ \App\Models\Learning\Discussion\LearningDiscussion::getDiscussionCount($course) > 1 ? 's':'' }}</label>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <input type="hidden" id="directReplyId"
                                                                               value="">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <button class="discussion-comment-reply float-right"
                                                        data-type="directCommentReply"
                                                        data-directreplyid="{{ $item->id }}"
                                                        data-commentid="{{ $item->id }}" data-toggle="modal"
                                                        data-target="#exampleModalCenter">
                                                    <img src="{{asset("images/icons/reply.png")}}" alt="">&nbsp;&nbsp;
                                                    Reply
                                                </button>
                                            </div>
                                        </div>
                                                    ...
                                                    @if($replies->status === 1)
                                                        <div class="row pl-3 mb-3">
                                                            <div class="col-12">
                                                                ...
                                                                <label for=""
                                                                       class="float-right discussion-comment-time">
                                ...
                                @if(\App\Models\Learning\Discussion\LearningDiscussion::getDiscussionCount($course) > 3)
                                    <div class="col-12 text-center">
                                        <a href="{{ route('yaedp.account.discussion.all', $course->id) }}"
                                           class="discussion-comment-text">Show all
                                            comments({{\App\Models\Learning\Discussion\LearningDiscussion::getDiscussionCount($course)}}
                                            )</a>
                                    </div>
                                @endif
                            </div>
            ...
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h5 class="text-inter font-weight-bold text-center">
                        This session is timed. Once you resume this session, you have to complete the course. Leaving or
                        closing the page before the timer ends will not complete the course.
                    </h5>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button class="btn ripple btn-success startCourse"
                            ...
                            data-study-timer="{{ $course->study_timer }}">Yes
                    </button>
