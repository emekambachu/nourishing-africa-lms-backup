    ...
    <section class="p-0 wow fadeIn bg-light"
        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6 col-sm-10 col-lg-4 wow fadeInLeft margin-20px-tb padding-four-all md-padding-eight-all md-padding-15px-lr sm-padding-50px-tb border-radius-4" style="visibility: visible; animation-name: fadeInLeft; background-color: #fff;">
                    <div class="row m-0">
                        <div class="col-12 margin-six-bottom lg-margin-six-bottom md-margin-30px-bottom sm-no-margin-bottom text-center">
                            ...
                            <p class="text-center font-normal-manrope-black">
                                Include your email to reset your password</p>
                        ...
                        <div class="col-12 aligncenter margin-six-bottom md-margin-30px-bottom last-paragraph-no-margin">
                            <form method="post" id="password-token-form">
                                @csrf
                                <div class="row" id="form-fields">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" id="password-token-btn"
                                                data-route="{{ route('yaedp.forgot-password.send-link') }}"
                                                class="login-form-btn">
                                            Send password reset token</button>
                                    </div>
