    ...
    <section class="p-0 bg-light"
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <div class="col-11 col-md-10 margin-50px-tb padding-four-all md-padding-eight-all md-padding-15px-lr sm-padding-50px-tb border-radius-4 card"
...
{{--                                We have been notified that some of you are experiencing difficulties accessing the YAEDP e-learning portal. We appreciate your emails and messages sent to inform us.<br><br>--}}
{{--                                Our team is now working on the backend to optimize the portal's responsiveness and efficiency. We expect that the issue will be resolved within the next few days and all participants will be able to access the portal without errors.<br><br>--}}
{{--                                Please be rest assured that we will amend the training dates accordingly to ensure that you still have the dedicated six weeks to complete the training.<br>--}}
{{--                                We will duly notify you via the existing communications channels as soon as the optimization process is complete.<br>--}}
