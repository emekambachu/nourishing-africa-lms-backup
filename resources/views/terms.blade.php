            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="justify-text">
                        Terms of Use of the African Food Changemakers Learning Management System<br><br>
                        The African Food Changemakers Learning Management System (“LMS”, “Portal”) offers products and services provided by African Food Changemakers Limited, (“African Food Changemakers"). These Terms of Use ("Terms") govern your use of our website, apps, and other products and services ("Services").<br>
                    ...
                    <div class="panel-group accordion-style3" id="accordion-3">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-One" class="panel-collapse collapse show" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">You may use this Service only if you have been granted exclusive access by African Food Changemakers, and only in compliance with these Terms and all applicable laws. When you create your profile account on the Portal, and subsequently when you use certain features, you must provide us with accurate and complete information, and you agree to update your information to keep it accurate and complete. Any use or access by anyone under the age of 18 is prohibited, and certain regions and Content Offerings may have additional requirements and/or restrictions.</p>
                                </div>
                            </div>
                        </div>
                        <!-- end tab content -->
                            ...
                            <div id="accordion-3-Two" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        ...
                                        You also agree that you will create, access, and/or use only one user account, unless expressly permitted by African Food Changemakers, and you will not share access to your account or access information for your account with any third party. Using our Services does not give you ownership of or any intellectual property rights in our Services or the content you access.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-Three" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        1.	African Food Changemakers offers courses and content ("Content Offerings") provided by expert Instructors, trainers or other providers ("Content Providers"). In these Terms of Use, ‘Content’ refers to all the content available on the Portal, including funding courses, videos, eBooks, and user materials.<br>
                                        2.	Sources of this Content may come from third-party websites or African Food Changemakers partner organizations. African Food Changemakers does not take responsibility for the content of any commentary/posts/links, etc., generated by users on any portion of the Portal.<br>
                                        3.	While we seek to provide world-class Content Offerings from our Content Providers, if unexpected events do occur, African Food Changemakers reserves the right to cancel, interrupt, reschedule, or modify any Content Offerings, or change the point value or weight of any assignment, quiz, or other assessment, either solely, or in accordance with Content Provider instructions. Content Offerings are subject to the Disclaimers and Limitation of Liability sections below.<br>
                                        4.	African Food Changemakers does not grant academic credit for the completion of Content Offerings. Unless otherwise explicitly indicated by a credit-granting institution, participation in or completion of Content Offerings does not confer any academic credit. Even if credit is awarded by one institution, there is no presumption that other institutions will accept that credit. African Food Changemakers and the associated Content Providers have no obligation to have Content Offerings recognized by any educational institution or accreditation organization.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-Four" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        1.	African Food Changemakers reserves the right to suspend or terminate the operation of the Portal at any time for the purposes of support and maintenance or to update the information contained on the Website.<br>
                                        2.	African Food Changemakers is not obliged to give any notice of such termination or suspension.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-Five" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        The Services enable you to share your content, such as homework, quizzes, exams, projects, other assignments you submit, posts you make in the forums, and the like ("User Content"), with African Food Changemakers, instructors, and/or other users. You retain all intellectual property rights in, and are responsible for, the User Content you create and share.<br>
                                        User Content does not include course content or other materials made available on or placed on to the Portal by or on behalf of African Food Changemakers and the Content Providers using the Services or Content Offerings. As between African Food Changemakers and Content Providers, such Content Offerings are governed by the relevant agreements in place between African Food Changemakers and Content Providers.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="privacy-policy-accordion-header">
                                <a class="accordion-toggle" data-toggle="collapse"
                                   data-parent="#accordion-3" href="#accordion-3-six">
                                    <div class="panel-title">
                                        <span class="text-white-2 sm-width-80 d-inline-block">
                                           F. How African Food Changemakers and Others May Use User Content</span>
                                        <i class="indicator fas fa-angle-down float-right"></i>
                                    </div>
                                </a>
                            </div>
                            <div id="accordion-3-six" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        To the extent that you provide User Content, you grant African Food Changemakers a fully transferable, royalty-free, perpetual, sublicensable, non-exclusive, worldwide license to copy, distribute, modify, create derivative works based on, publicly perform, publicly display, and otherwise use the User Content.<br>
                                        This license includes granting African Food Changemakers the right to authorize Content Providers to use User Content with their registered users. We reserve the right to remove or modify User Content for any reason, including User Content that we believe violates these Terms or other policies including our Acceptable Use Policy and Code of Conduct.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-seven" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        We welcome your suggestions, ideas, comments, and other feedback regarding the Services ("Feedback"). By submitting any Feedback, you grant us the right to use the Feedback without any restriction or any compensation to you. By accepting your Feedback, African Food Changemakers does not waive any rights to use similar or related Feedback previously known to African Food Changemakers, developed by our employees, contractors, or obtained from other sources.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-eight" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        We care about the security of our users. While we work to protect the security of your account and related information, African Food Changemakers cannot guarantee that unauthorized third parties will not be able to defeat our security measures. Please notify us immediately of any compromise or unauthorized use of your account by emailing YAEDP@nourishingafrica.com
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="accordion-3-nine" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        ...
                                        3.	It is a violation of these Terms to use the Portal or any information obtained from the Website in order to: (i) harass, abuse, or harm another person (including, but not limited to, using profanity in messages or joining collaborator teams in bad faith), (ii) contact, advertise to, solicit, or sell to any User or other person without their prior explicit consent. In order to protect such persons, African Food Changemakers reserves the right to remove content from Users that violates the acceptable use and place restriction on the violating User's account at African Food Changemakers's sole and absolute discretion.<br>
                                        4.	Users shall not use the Portal or its content to post or submit content (including but not limited to, written materials or images) at any time for any purpose that in African Food Changemakers's opinion is unlawful, prohibited, threatening, abusive, defamatory, libelous, invasive of privacy or publicity rights, hateful or offensive on racial, ethnic, sexual or any other grounds, vulgar, obscene, profane or otherwise objectionable, which encourages conduct that would constitute a criminal offence, gives rise to civil liability or otherwise violates any law. Users shall comply with any applicable local, state, national or international statutes, rules, regulations, ordinances, decrees, laws, codes, orders, regulations or treaties when using the Portal.<br>
                                        5.	Other than as expressly outlined in these Terms, Users may not reproduce, republish, upload, post, modify, copy, alter, distribute, sell, resell, transmit, transfer, decompile, license, assign, publish or exploit, in any way, any Content on the Portal without the express written permission of African Food Changemakers and the copyright owner. No changes in or deletion of author attribution, trademark legend or copyright notice shall be made, and no ownership rights shall be transferred in the event of any permitted copying, redistribution or publication of copyrighted material.<br>
                                        6.	The Portal includes features and functionalities whereby a User may post and transmit information, images and other materials. All such information, images and materials, whether publicly posted or publicly or privately transmitted, are the sole responsibility of the Member who originates such content. African Food Changemakers reserves the right to remove or refuse to post or distribute any content and restrict, suspend, or terminate the participation of any Member from the Portal and from all African Food Changemakers Services at any time, with or without prior notice.<br>
                                        ...
                                        a)	I will register with only one account, unless expressly permitted to register for additional accounts by African Food Changemakers.<br>
                                        b)	My answers to assignment, quizzes, exams, projects, and other assignments will be my own work (except for assignments that explicitly permit collaboration) as specified in the African Food Changemakers.<br>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-ten" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        African Food Changemakers respects the intellectual property rights of our Content Providers, Users, and other third parties and expects our users to do the same when using the Services. We reserve the right to suspend, disable, or terminate the accounts of users who repeatedly infringe or are repeatedly charged with infringing the copyrights, trademarks, or other intellectual property rights of others.<br>
                                        If you believe in good faith that materials on the African Food Changemakers Portal infringe your copyright, you may send us a notice requesting that the material be removed or access to it blocked.<br>
                                        ...
                                        The official emblem or logo of African Food Changemakers, shall not, under any circumstances, be used without African Food Changemakers’s prior written consent, nor represent or imply an association or affiliation with African Food Changemakers.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-twelve" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        African Food Changemakers respects the intellectual property rights of our users, Content Providers, and other third parties and expects our users to do the same when using the Services. We have adopted and implemented the African Food Changemakers Copyright and Trademark Policy below in accordance with applicable law, including the Digital Millennium Copyright Act.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-thirteen" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        African Food Changemakers may modify these Terms in its sole discretion from time to time, and such modifications shall automatically become part of these Terms and shall be effective once posted by African Food Changemakers on the Portal. Users’ use of the Portal will be subject to any such modifications.<br>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="accordion-3-fourteen" class="panel-collapse collapse" data-parent="#accordion-3">
                                <div class="privacy-policy-accordion-body">
                                    <p class="justify-text">
                                        We are constantly changing and improving our Services. We may add or remove functions, features, or requirements, and we may suspend (to the extent allowed by applicable law) or stop part of our Services altogether. Accordingly, African Food Changemakers has the right to terminate any User’s account if found to be in violation of these Terms.<br>
                                        We may not be able to deliver the Services to certain regions or countries for various reasons, due to applicable export control requirements or internet access limitations and restrictions from governing authorities. None of African Food Changemakers, its Content Providers, its contributors, sponsors, and other business partners, and their employees, contractors, and other agents (the "Nourishing Africa Parties") shall have any liability to you for any such action. You can stop using our Services at any time.
                                    </p>
                                </div>
                            </div>
                        </div>
